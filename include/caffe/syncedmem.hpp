...
CAFFE_FUNCTION_EXPORTS inline void CaffeMallocHost(void** ptr, size_t size) {
  *ptr = malloc(size);
  CHECK(*ptr) << "host allocation of size " << size << " failed";
}

CAFFE_FUNCTION_EXPORTS inline void CaffeFreeHost(void* ptr) {
  free(ptr);
}
 ...
 */
class CAFFE_CLASS_EXPORTS SyncedMemory {
 public:
  SyncedMemory()
