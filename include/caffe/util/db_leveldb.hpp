...
class CAFFE_CLASS_EXPORTS LevelDBCursor : public Cursor {
 public:
...
class CAFFE_CLASS_EXPORTS LevelDBTransaction : public Transaction {
 public:
...
class CAFFE_CLASS_EXPORTS LevelDB : public DB {
 public:
  LevelDB() : db_(NULL) { }
