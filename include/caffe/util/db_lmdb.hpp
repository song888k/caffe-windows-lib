...
CAFFE_FUNCTION_EXPORTS inline void MDB_CHECK(int mdb_status) {
  CHECK_EQ(mdb_status, MDB_SUCCESS) << mdb_strerror(mdb_status);
}

class CAFFE_CLASS_EXPORTS LMDBCursor : public Cursor {
 public:
...
class CAFFE_CLASS_EXPORTS LMDBTransaction : public Transaction {
 public:
...
class CAFFE_CLASS_EXPORTS LMDB : public DB {
 public:
  LMDB() : mdb_env_(NULL) { }
  virtual ~LMDB() { Close(); }
