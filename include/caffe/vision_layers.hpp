...
class CAFFE_CLASS_EXPORTS BaseConvolutionLayer : public Layer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS ConvolutionLayer : public BaseConvolutionLayer<Dtype> {
 public:
  /**
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS DeconvolutionLayer : public BaseConvolutionLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS Im2colLayer : public Layer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS LRNLayer : public Layer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS PoolingLayer : public Layer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS SPPLayer : public Layer<Dtype> {
 public:
