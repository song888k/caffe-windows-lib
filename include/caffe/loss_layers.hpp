...
class CAFFE_CLASS_EXPORTS AccuracyLayer : public Layer<Dtype> {
 public:
  /**
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS LossLayer : public Layer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS ContrastiveLossLayer : public LossLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS EuclideanLossLayer : public LossLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS HingeLossLayer : public LossLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS InfogainLossLayer : public LossLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS MultinomialLogisticLossLayer : public LossLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS SigmoidCrossEntropyLossLayer : public LossLayer<Dtype> {
 public:
 ...
 */
template <typename Dtype>
class CAFFE_CLASS_EXPORTS SoftmaxWithLossLayer : public LossLayer<Dtype> {
 public:
   /**
